...
export const CONTENT = [
     new Content('co1', 'check', 'cl1', 'Я ел что-то в последние 4-5 часов?'),
     new Content(
          'co2',
          'check',
          'cl1',
     ...
     new Content('co4', 'check', 'cl1', 'испытываете гнев, агрессивны'),
     new Content(
          'co5',
          'check',
          'cl1',
     ...
     new Content('co6', 'check', 'cl3', 'травма произошла менее 3 дней назад'),
     new Content(
          'co7',
          'check',
          'cl3',
